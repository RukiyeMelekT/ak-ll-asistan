...
r=sr.Recognizer() #speech recognition ile alınan sesi r
...
def record(ask = False):#record adlı bir fonksiyon oluşturuyoruz ve varsayılan olarak ask =false olarak ayarlıyouz
    with sr.Microphone() as source: #mikrofandan gelen veriyi işlem yapabilmek için source e tanımlıyoruz
        ...
        try:#
            ...
            print(Fore.GREEN)
            print("AHRE  = ne dedin, anlamadım , acaba tekrar edermisin")
            ...
            print(Fore.GREEN)
            print('AHRE  = Sistemin çalışmıyor')
...
def response(voice):#voice ile gelen veriyi sorgululamak için response adında bir fonkiyon
    ...
    if 'iyiyim' in voice:# eğer voice nin içinde iyiyim diye bir değer varsa bunları yap
        print(Fore.GREEN)
        print("AHRE  = iyi olmana sevindim senin için ne yapabilirim")#ekrana yazılacak veri
    ...
    if 'kötüyüm'  in voice:# eğer voice nin içinde kötüyüm diye bir değer varsa bunları yap
        ...
        print(Fore.GREEN)
        print("AHRE  = "+secimolumsuz)#seçilen söz ekrana yazılması için
    ...
    if 'fıkra anlat' in voice:# eğer voice nin içinde Fıkra anlat diye bir değer varsa bunları yap
        ...
        print(Fore.GREEN)
        print("AHRE  = "+secimfık)#seçilen söz ekrana yazılması için
    ...
    if 'hikaye anlat' in voice:# eğer voice nin içinde hikaye anlat diye bir değer varsa bunları yap
        ...
        print(Fore.GREEN)
        print("AHRE  = "+secimhikaye)#seçilen hikaye ekrana yazılması için
    ...
    if 'sen kimsin'  in voice:# eğer voice nin içinde sen kimsin diye bir değer varsa bunları yap
        print(Fore.GREEN)
        speak('Benim adım AHRE asistanım. İsmimin anlamını bilmiyorum. Kurucum anlamının özel olduğunu düşündüğü için bana söylemedi.')#selendirelecek
        print('AHRE  = Benim adım AHRE asistanım. İsmimin anlamını bilmiyorum. Kurucum anlamının özel olduğunu düşündüğü için bana söylemedi.')#ekrana yazılacak
    ...
    if 'saat kaç' in voice:# eğer voice nin içinde saat kaç diye bir değer varsa bunları yap
        ...
        print(Fore.GREEN)
        print("AHRE  = "+datetime.now().strftime('%H:%M:%S'))#datetime.now sayesinde anlık saati alıyoruz ve yazdırıyoruz
    ...
    if 'arama yap' in voice:# eğer voice nin içinde arama yap diye bir değer varsa bunları yap
        ...
        print(Fore.GREEN)
        print("AHRE = "+search+' için bulduğum sonuçlar')#ekrana yazdırma yapıyouz
    ...
    if "youtube'da ara" in voice:# eğer voice nin içinde arama yap diye bir değer varsa bunları yap
        ...
        print(Fore.GREEN)
        print("AHRE  = "+searchy+' için bulduğum sonuçlar') #ekrana yazdırma yapıyouz
    ...
    if 'hava durumu' in voice:# eğer voice nin içinde hava durumu diye bir değer varsa bunları yap
        ...
        print(Fore.GREEN)
        print("AHRE  = "+havail+" için hava"+havadetay+" derece")#ekrana yazdırıyouz
    ...
    if 'güle güle' in voice:# eğer voice nin içinde güle güle diye bir değer varsa bunları yap
        ...
        print(Fore.GREEN)
        print('AHRE  = görüşürüz')#ekrana yazdırıyouz
...
print(Fore.GREEN)
print('AHRE  = Seni dinliyorum Senin için ne yapabilirim')#ilk açılışta asiatanın bizi karşılamasını yazdırmak için
